...
English stays visible on the GitHub release page. Extra languages are placed inside one collapsible `<details>` section so visitors do not have to scroll through every translation to reach the release assets.
